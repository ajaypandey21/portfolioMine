      ...
      <section className="mr-">
        ...
        <form>
          <input
            name="query"
            type="text"
            className=" focus:outline-none bg-gray-300 sm:w-[20rem] w-[32rem] h-14 px-2"
          ></input>
          <button className="p-4 border-r  bg-gray-300 rounded-r-full">
            Submit
          </button>
        </form>
      </section>
