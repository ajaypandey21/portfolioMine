...
const Quotes = () => {
  ...
  const img = [steve, bill, larry, linus];
  const names = ["Steve Jobs", "Bill Gates", "Larry Page", "Linus Torvalds"];
  ...
  return (
    <div className="p-4">
        ...
        <button
          ...
          className="absolute top-[34%] left-[15%]"
        >
          <svg
        ...
        <button
          ...
          className="absolute top-[34%] left-[80%]"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
        ...
        >
          ...
          {lines.map((it, i) => (
            <h2 className={"p-7 " + (activeLines === i ? "block" : "hidden")}>
              "{it}."
            </h2>
          ))}
          {names.map((it, i) => (
            <p className={"p-3 " + (activeName === i ? "block" : "hidden")}>
              by <b>{it}.</b>
            </p>
          ))}
        </section>
